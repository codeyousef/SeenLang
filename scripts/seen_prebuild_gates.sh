...
bash -n "$SCRIPT_DIR/artifact_root.sh" \
    ...
    "$REPO_ROOT/tests/misc_root_tests/seen_bundled_cuda_link.sh" \
...
echo "Prebuild gates: human JSON and JUnit reporter contract..."
bash "$REPO_ROOT/tests/misc_root_tests/seen_test_reporters_contract.sh"
