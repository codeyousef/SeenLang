...
COMPILER="$REAL_COMPILER" bash "$REPO_ROOT/tests/misc_root_tests/seen_option_free_layout_contract.sh"
COMPILER="$REAL_COMPILER" bash "$REPO_ROOT/tests/misc_root_tests/seen_option_payload_width_contract.sh"
COMPILER="$REAL_COMPILER" bash "$REPO_ROOT/tests/misc_root_tests/seen_result_string_unwrap_contract.sh"
COMPILER="$REAL_COMPILER" bash "$REPO_ROOT/tests/misc_root_tests/seen_runtime_cstring_accounting.sh"
...
COMPILER="$REAL_COMPILER" \
    "$REPO_ROOT/tests/misc_root_tests/seen_result_scalar_payload_contract.sh"
COMPILER="$REAL_COMPILER" \
    "$REPO_ROOT/tests/misc_root_tests/seen_integer_string_width_contract.sh"
COMPILER="$REAL_COMPILER" \
...
COMPILER="$REAL_COMPILER" \
    "$REPO_ROOT/tests/misc_root_tests/seen_repr_c_aggregate_field_assignment_contract.sh"
COMPILER="$REAL_COMPILER" \
...
COMPILER="$REAL_COMPILER" \
    "$REPO_ROOT/tests/misc_root_tests/seen_repr_c_aggregate_array_push_contract.sh"
COMPILER="$REAL_COMPILER" \
    "$REPO_ROOT/tests/misc_root_tests/seen_class_destruction_accounting_contract.sh"
COMPILER="$REAL_COMPILER" \
...
COMPILER="$REAL_COMPILER" \
    "$REPO_ROOT/tests/misc_root_tests/seen_default_constant_arguments_contract.sh"
SEEN_BIN="$REAL_COMPILER" \
...
run_fixture bounded-byte-adapters \
