...
fn test_all_languages_have_required_keywords() {
    ...
    for lang in &languages {
        ...
        assert!(
            fun_keyword.is_some(),
            "Language {} missing 'fun' keyword",
            lang
        );
        assert!(
            if_keyword.is_some(),
            "Language {} missing 'if' keyword",
            lang
        );
        assert!(
            !and_keyword.is_empty(),
            "Language {} missing 'and' keyword",
            lang
        );
        assert!(
            !or_keyword.is_empty(),
            "Language {} missing 'or' keyword",
            lang
        );
        assert!(
            !not_keyword.is_empty(),
            "Language {} missing 'not' keyword",
            lang
        );
...
fn test_language_isolation() {
    ...
    assert_ne!(
        en_fun, ar_fun,
        "English and Arabic 'fun' keywords should be different"
    );
    assert_ne!(
        en_and, ar_and,
        "English and Arabic 'and' keywords should be different"
    );
