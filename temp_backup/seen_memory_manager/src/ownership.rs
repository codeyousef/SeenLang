    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            OwnershipError::UseAfterMove {
                ...
                write!(
                    f,
                    "Variable '{}' used at {} after being moved at {}",
                    variable, used_at, moved_at
                )
            }
            OwnershipError::MultipleMutableBorrows {
                variable,
                first_borrow,
                second_borrow,
            } => {
                write!(
                    f,
                    "Variable '{}' borrowed mutably multiple times: first at {}, second at {}",
            ...
            OwnershipError::BorrowConflict {
                ...
                write!(
                    f,
                    "Variable '{}' has borrow conflict: immutable at {}, mutable at {}",
            ...
            OwnershipError::BorrowAfterMove {
                ...
                write!(
                    f,
                    "Variable '{}' borrowed at {} after being moved at {}",
...
impl OwnershipAnalyzer {
    ...
    pub fn analyze_expression(
        &mut self,
        expr: &Expression,
    ) -> Result<OwnershipMode, OwnershipError> {
        match expr {
            ...
            Expression::ForceUnwrap { nullable, .. } => self.analyze_expression(nullable),
