...
pub use interface_manager::{InterfaceManager, InterfaceManagerConfig, InterfaceValidationResult};
pub use method_manager::{
    MethodManager, MethodManagerConfig, MethodResolutionResult, ResolutionContext,
};
pub use types::{
    DispatchType, Extension, Interface, InterfaceImplementation, Method, MethodCall,
    MethodDispatch, MethodError, MethodSignature, MethodVisibility, Parameter, ReceiverType,
};
...
mod tests {
    ...
    fn test_method_visibility() {
        assert_eq!(
            MethodVisibility::from_name("PublicMethod"),
            MethodVisibility::Public
        );
        assert_eq!(
            MethodVisibility::from_name("privateMethod"),
