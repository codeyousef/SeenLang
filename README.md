...
<p align="center">
  ...
  <a href="docs/cli-reference.md"><img src="https://img.shields.io/badge/release-0.21.1-2f855a.svg" alt="Seen 0.21.1"></a>
...
Seen 0.21.1 resolves package dependencies declared in `Seen.toml` and records
...
release LTO, and packages. Current 0.21.1 baseline coverage includes:
