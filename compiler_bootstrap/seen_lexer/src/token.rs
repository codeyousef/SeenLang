        ...
        match self {
            ...
            _ => {
                let token_str = match self {
                    ...
                    TokenType::KeywordReified => "reified",
                    TokenType::KeywordCrossinline => "crossinline",
                    TokenType::KeywordNoinline => "noinline",
                    TokenType::KeywordBy => "by",
                    TokenType::KeywordData => "data",
                    TokenType::KeywordSealed => "sealed",
                    TokenType::KeywordObject => "object",
                    ...
                    TokenType::KeywordLateinit => "lateinit",
                    TokenType::KeywordCompanion => "companion",
