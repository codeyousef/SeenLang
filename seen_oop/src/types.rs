...
pub enum MethodError {
    ...
    InvalidReceiver { reason: String, position: Position },

    /// Invalid method signature
    #[error("Invalid method signature: {reason} at {position}")]
    InvalidSignature { reason: String, position: Position },
    ...
    ReservedMethodName { name: String, position: Position },
...
mod tests {
    ...
    fn test_method_visibility_from_name() {
        assert_eq!(
            MethodVisibility::from_name("GetName"),
            MethodVisibility::Public
        );
        assert_eq!(
            MethodVisibility::from_name("getName"),
        ...
        assert_eq!(
            MethodVisibility::from_name("UpdateAge"),
            MethodVisibility::Public
        );
        assert_eq!(
            MethodVisibility::from_name("updateAge"),
