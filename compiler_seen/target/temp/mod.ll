...
@.str.1 = private unnamed_addr constant [60 x i8] c"Bootstrap: Complete - Full Compiler Functionality Available\00", align 1
...
entry:
  ...
  call void @println(i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.1, i32 0, i32 0))
  ret i32 0
}
