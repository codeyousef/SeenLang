...
TARBALL="$DIST_DIR/seen-0.9.4-linux-x64.tar.gz"
test -f "$TARBALL"
...
PACKAGE_DIR="$EXTRACT_DIR/seen-0.9.4-linux-x64"
...
if ! "$PREFIX/bin/seen" --version | grep -q '0.9.4'; then
...
grep -Fq '## [0.9.4] - 2026-07-13' "$PACKAGE_DIR/share/doc/seen/CHANGELOG.md"
