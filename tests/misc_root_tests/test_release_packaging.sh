...
TARBALL="$DIST_DIR/seen-0.9.0-linux-x64.tar.gz"
test -f "$TARBALL"
...
PACKAGE_DIR="$EXTRACT_DIR/seen-0.9.0-linux-x64"
...
if ! "$PREFIX/bin/seen" --version | grep -q '0.9.0'; then
