...
mod safe_navigation_tests {
    ...
    fn test_safe_navigation_operator() {
        ...
        assert_eq!(
            token1.token_type,
            TokenType::PrivateIdentifier("user".to_string())
        );
        ...
        assert_eq!(
            token3.token_type,
            TokenType::PrivateIdentifier("name".to_string())
        );
    }
    ...
    fn test_chained_safe_navigation() {
        ...
        assert_eq!(
            token3.token_type,
            TokenType::PrivateIdentifier("profile".to_string())
        );
        ...
        assert_eq!(
            token5.token_type,
            TokenType::PrivateIdentifier("address".to_string())
        );
        ...
        assert_eq!(
            token7.token_type,
            TokenType::PrivateIdentifier("city".to_string())
        );
    }
    ...
    fn test_safe_navigation_with_method_call() {
        ...
        assert_eq!(
            token3.token_type,
            TokenType::PublicIdentifier("GetName".to_string())
        );
...
mod elvis_operator_tests {
    ...
    fn test_elvis_operator() {
        ...
        assert_eq!(
            token3.token_type,
            TokenType::StringLiteral("Unknown".to_string())
        );
    }
    ...
    fn test_elvis_with_complex_expression() {
        ...
        assert_eq!(
            token1.token_type,
            TokenType::PrivateIdentifier("getUserName".to_string())
        );
        ...
        assert_eq!(
            token5.token_type,
            TokenType::PrivateIdentifier("defaultName".to_string())
        );
    }
...
mod force_unwrap_tests {
    ...
    fn test_force_unwrap_operator() {
        ...
        assert_eq!(
            token1.token_type,
            TokenType::PrivateIdentifier("maybeValue".to_string())
        );
    ...
    fn test_multiple_force_unwraps() {
        ...
        assert_eq!(
            token1.token_type,
            TokenType::PrivateIdentifier("a".to_string())
        );
        ...
        assert_eq!(
            token4.token_type,
            TokenType::PrivateIdentifier("b".to_string())
        );
...
mod combined_nullable_tests {
    ...
    fn test_safe_navigation_with_elvis() {
        ...
        assert_eq!(
            token3.token_type,
            TokenType::PublicIdentifier("Name".to_string())
        );
        ...
        assert_eq!(
            token5.token_type,
            TokenType::StringLiteral("Anonymous".to_string())
        );
    }
    ...
    fn test_all_nullable_operators_together() {
        ...
        assert_eq!(
            token4.token_type,
            TokenType::PublicIdentifier("Profile".to_string())
        );
        ...
        assert_eq!(
            token6.token_type,
            TokenType::PrivateIdentifier("defaultProfile".to_string())
        );
    ...
    fn test_nullable_with_question_mark() {
        ...
        assert_eq!(
            token1.token_type,
            TokenType::PrivateIdentifier("isReady".to_string())
        );
        ...
        assert_eq!(
            token3.token_type,
            TokenType::PrivateIdentifier("value".to_string())
        );
    }
}
