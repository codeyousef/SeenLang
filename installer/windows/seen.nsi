...
;
; Build on Linux:  makensis -DVERSION=0.20.15 -DSOURCE_DIR=path/to/staged seen.nsi
; Build on Windows: makensis /DVERSION=0.20.15 /DSOURCE_DIR=path\to\staged seen.nsi
;
; Install NSIS:
