...
param(
    ...
    [string]$OutputFile = "",
    [string]$GitHubRepo = "codeyousef/SeenLang",
...
function Show-Help {
    ...
    Write-Host ""
    Write-Host "Required:"
    Write-Host "  -Version VERSION         Release version (e.g., 0.20.12)"
    Write-Host ""
    Write-Host "Options:"
    ...
    Write-Host "  -GitHubRepo REPO         GitHub repository (default: codeyousef/SeenLang)"
    Write-Host "  -Verbose                 Enable verbose output"
    Write-Host ""
    Write-Host "If URLs/hashes are not provided, they will be auto-generated from GitHub releases."
    Write-Host ""
    Write-Host "Examples:"
    Write-Host "  .\generate-manifest.ps1 -Version 0.20.12"
