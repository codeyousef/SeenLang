...
show_getting_started() {
    ...
    echo ""
    echo -e "${BLUE}  # Create Seen.toml and src/main.seen, then:${NC}"
    echo -e "${BLUE}  cd my-project${NC}"
    echo ""
    echo -e "${BLUE}  seen check src/main.seen${NC}"
    echo ""
    echo -e "${BLUE}  seen run src/main.seen${NC}"
    echo -e "${BLUE}  seen compile src/main.seen my-project${NC}"
    echo ""
