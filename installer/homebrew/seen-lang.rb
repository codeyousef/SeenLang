class SeenLang < Formula
  ...
  url "https://github.com/codeyousef/SeenLang/releases/download/v0.22.2/seen-0.22.2-macos-x64.tar.gz"
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      url "https://github.com/codeyousef/SeenLang/releases/download/v0.22.2/seen-0.22.2-macos-arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/codeyousef/SeenLang/releases/download/v0.22.2/seen-0.22.2-linux-x64.tar.gz"
      sha256 "abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789"
    elsif Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/codeyousef/SeenLang/releases/download/v0.22.2/seen-0.22.2-linux-arm64.tar.gz"
  ...
  def install
    ...
    # The 0.22.2 CLI does not expose a completion-generator subcommand.
  end
...
class SeenLang
  ...
  bottle do
    root_url "https://github.com/codeyousef/SeenLang/releases/download/v0.22.2/"
  ...
  resource "language-configs" do
    url "https://github.com/codeyousef/SeenLang/releases/download/v0.22.2/language-configs.tar.gz"
    sha256 "567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234"
  end

  resource "stdlib-source" do
    url "https://github.com/codeyousef/SeenLang/releases/download/v0.22.2/stdlib-source.tar.gz"
