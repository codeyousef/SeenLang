class SeenLang < Formula
  ...
  url "https://github.com/codeyousef/SeenLang/releases/download/v0.20.10/seen-0.20.10-macos-x64.tar.gz"
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      url "https://github.com/codeyousef/SeenLang/releases/download/v0.20.10/seen-0.20.10-macos-arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/codeyousef/SeenLang/releases/download/v0.20.10/seen-0.20.10-linux-x64.tar.gz"
      sha256 "abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789"
    elsif Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/codeyousef/SeenLang/releases/download/v0.20.10/seen-0.20.10-linux-arm64.tar.gz"
  ...
  def install
    ...
    # The 0.20.10 CLI does not expose a completion-generator subcommand.
  end
...
class SeenLang
  ...
  bottle do
    root_url "https://github.com/codeyousef/SeenLang/releases/download/v0.20.10/"
  ...
  resource "language-configs" do
    url "https://github.com/codeyousef/SeenLang/releases/download/v0.20.10/language-configs.tar.gz"
    sha256 "567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234"
  end

  resource "stdlib-source" do
    url "https://github.com/codeyousef/SeenLang/releases/download/v0.20.10/stdlib-source.tar.gz"
