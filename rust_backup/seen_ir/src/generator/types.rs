...
impl IRGenerator {
    ...
    pub(crate) fn register_import_types(
        ...
        match module_path {
            ...
            "lexer.token_type" | "compiler_seen.lexer.token_type" => {
                // Register SeenTokenType as an enum type (simple enum with no data variants)
                let variants: Vec<(String, Option<Vec<IRType>>)> = vec![
                    ("IntegerLiteral".to_string(), None),
                    ("FloatLiteral".to_string(), None),
                    ("StringLiteral".to_string(), None),
                    ("CharLiteral".to_string(), None),
                    ("BooleanLiteral".to_string(), None),
                    ("KeywordFalse".to_string(), None),
                    ("Identifier".to_string(), None),
                    ("KeywordFun".to_string(), None),
                    ("KeywordLet".to_string(), None),
                    ("KeywordVar".to_string(), None),
                    ("KeywordIf".to_string(), None),
                    ("KeywordElse".to_string(), None),
                    ("KeywordWhile".to_string(), None),
                    ("KeywordFor".to_string(), None),
                    ("KeywordIn".to_string(), None),
                    ("KeywordReturn".to_string(), None),
                    ("KeywordBreak".to_string(), None),
                    ("KeywordContinue".to_string(), None),
                    ("KeywordClass".to_string(), None),
                    ("KeywordInterface".to_string(), None),
                    ("KeywordEnum".to_string(), None),
                    ("KeywordExtends".to_string(), None),
                    ("KeywordImplements".to_string(), None),
                    ("KeywordAsync".to_string(), None),
                    ("KeywordAwait".to_string(), None),
                    ("KeywordSpawn".to_string(), None),
                    ("KeywordMatch".to_string(), None),
                    ("KeywordTry".to_string(), None),
                    ("KeywordCatch".to_string(), None),
                    ("KeywordFinally".to_string(), None),
                    ("KeywordThrow".to_string(), None),
                    ("KeywordImport".to_string(), None),
                    ("KeywordUse".to_string(), None),
                    ("KeywordExport".to_string(), None),
                    ("KeywordAs".to_string(), None),
                    ("KeywordIs".to_string(), None),
                    ("KeywordNull".to_string(), None),
                    ("KeywordTrue".to_string(), None),
                    ("KeywordThis".to_string(), None),
                    ("KeywordSuper".to_string(), None),
                    ("KeywordMove".to_string(), None),
                    ("KeywordBorrow".to_string(), None),
                    ("Plus".to_string(), None),
                    ("Minus".to_string(), None),
                    ("Multiply".to_string(), None),
                    ("Divide".to_string(), None),
                    ("Modulo".to_string(), None),
                    ("Equal".to_string(), None),
                    ("PlusEqual".to_string(), None),
                    ("MinusEqual".to_string(), None),
                    ("MultiplyEqual".to_string(), None),
                    ("DivideEqual".to_string(), None),
                    ("EqualEqual".to_string(), None),
                    ("NotEqual".to_string(), None),
                    ("LessThan".to_string(), None),
                    ("LessEqual".to_string(), None),
                    ("GreaterThan".to_string(), None),
                    ("GreaterEqual".to_string(), None),
                    ("LogicalAnd".to_string(), None),
                    ("LogicalOr".to_string(), None),
                    ("LogicalNot".to_string(), None),
                    ("SafeNavigation".to_string(), None),
                    ("Elvis".to_string(), None),
                    ("Question".to_string(), None),
                    ("LeftParen".to_string(), None),
                    ("RightParen".to_string(), None),
                    ("LeftBrace".to_string(), None),
                    ("RightBrace".to_string(), None),
                    ("LeftBracket".to_string(), None),
                    ("RightBracket".to_string(), None),
                    ("Comma".to_string(), None),
                    ("Semicolon".to_string(), None),
                    ("Colon".to_string(), None),
                    ("Dot".to_string(), None),
                    ("Arrow".to_string(), None),
                    ("InterpolatedStringStart".to_string(), None),
                    ("InterpolatedStringMiddle".to_string(), None),
                    ("InterpolatedStringEnd".to_string(), None),
                    ("Newline".to_string(), None),
                    ("Whitespace".to_string(), None),
                    ("Comment".to_string(), None),
                    ("Error".to_string(), None),
                    ("EndOfFile".to_string(), None),
                    ("None".to_string(), None),
                ];
                let enum_type = IRType::Enum {
                    name: "SeenTokenType".to_string(),
                    variants,
                };
                self.context
                    .type_definitions
                    .insert("SeenTokenType".to_string(), enum_type.clone());
                let type_def = TypeDefinition::new("SeenTokenType", enum_type);
                module.add_type(type_def);
            }
            "lexer.interfaces" | "compiler_seen.lexer.interfaces" => {
                // Token class imports SeenTokenType, so register it here too if not already registered
                if !self.context.type_definitions.contains_key("SeenTokenType") {
                    // Use the same enum definition as lexer.token_type
                    let variants: Vec<(String, Option<Vec<IRType>>)> = vec![
                        ("IntegerLiteral".to_string(), None),
                        ("FloatLiteral".to_string(), None),
                        ("StringLiteral".to_string(), None),
