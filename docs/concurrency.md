...
Seen 0.16.0 provides LLVM-coroutine async functions, a cooperative runtime,
...
In the shipped 0.16.0 compiler, a parallel body has no capture environment.
...
safety intent, but 0.16.0 does not use them to make outer-local captures in
