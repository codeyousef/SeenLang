...
Seen 0.11.1 provides LLVM-coroutine async functions, a cooperative runtime,
...
In the shipped 0.11.1 compiler, a parallel body has no capture environment.
...
safety intent, but 0.11.1 does not use them to make outer-local captures in
