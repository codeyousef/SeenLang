...
Seen 0.18.1 provides a focused set of compile-time expressions and generated
...
runtime calls are not established 0.18.1 features.
...
compact top-level help in 0.18.1.
