...
- `llvm_ir_gen.seen` has been reduced from the plan baseline of `16,086` lines to `13,649` lines.
...
- Current large-method snapshot:
  ...
  - `generateMethodCall()` is down to about `237` lines.
