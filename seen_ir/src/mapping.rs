    ...
    match operator {
        ...
        BinaryOperator::Modulo => {
            if left.is_int_value() {
                ...
                Ok(builder
                    .build_int_signed_rem(left_int, right_int, "modtmp")?
                    .into())
            } else {
                Err(error_fn(format!(
        ...
        BinaryOperator::Equal => {
            if left.is_int_value() {
                ...
                let right_int = right.into_int_value();
                Ok(builder
                    .build_int_compare(IntPredicate::EQ, left_int, right_int, "eqtmp")?
                    .into())
            } else if left.is_float_value() {
                let left_float = left.into_float_value();
                let right_float = right.into_float_value();
        ...
        BinaryOperator::NotEqual => {
            if left.is_int_value() {
                ...
                let right_int = right.into_int_value();
                Ok(builder
                    .build_int_compare(IntPredicate::NE, left_int, right_int, "netmp")?
                    .into())
            } else if left.is_float_value() {
                let left_float = left.into_float_value();
                let right_float = right.into_float_value();
        ...
        BinaryOperator::LessThan => {
            if left.is_int_value() {
                ...
                let right_int = right.into_int_value();
                Ok(builder
                    .build_int_compare(IntPredicate::SLT, left_int, right_int, "lttmp")?
                    .into())
            } else if left.is_float_value() {
                let left_float = left.into_float_value();
                let right_float = right.into_float_value();
        ...
        BinaryOperator::GreaterThan => {
            if left.is_int_value() {
                ...
                let right_int = right.into_int_value();
                Ok(builder
                    .build_int_compare(IntPredicate::SGT, left_int, right_int, "gttmp")?
                    .into())
            } else if left.is_float_value() {
                let left_float = left.into_float_value();
                let right_float = right.into_float_value();
        ...
        BinaryOperator::LessEqual => {
            if left.is_int_value() {
                ...
                let right_int = right.into_int_value();
                Ok(builder
                    .build_int_compare(IntPredicate::SLE, left_int, right_int, "letmp")?
                    .into())
            } else if left.is_float_value() {
                let left_float = left.into_float_value();
                let right_float = right.into_float_value();
        ...
        BinaryOperator::GreaterEqual => {
            if left.is_int_value() {
                ...
                let right_int = right.into_int_value();
                Ok(builder
                    .build_int_compare(IntPredicate::SGE, left_int, right_int, "getmp")?
                    .into())
            } else if left.is_float_value() {
                let left_float = left.into_float_value();
                let right_float = right.into_float_value();
        ...
        BinaryOperator::And => {
            if left.is_int_value() {
                ...
                Err(error_fn(format!(
                    "Cannot perform logical AND on values of this type"
                )))
            }
        }
        BinaryOperator::Or => {
            if left.is_int_value() {
                ...
                Err(error_fn(format!(
                    "Cannot perform logical OR on values of this type"
                )))
            }
        }
    }
    ...
    match operator {
        ...
        UnaryOperator::Not => {
            if operand.is_int_value() {
                ...
                Err(error_fn(format!(
                    "Cannot apply logical NOT to values of this type"
                )))
            }
        }
        UnaryOperator::Plus => {
